...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="Server=geodbserver; Service=5151/tcp; Database=cadastral; User=sde; Version=sde.DEFAULT" type="ArcSDE Connection" name="SDE Feature Class" format="" mimeType="" description="" size=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minx="129060.13944400000036694" miny="469064.45479400001931936" maxy="3110618.31169300014153123" maxz="0" dimensions="2" crs="EPSG:4326" maxx="460039.91220299998531118" minz="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
