...
import { ViewPaymentAdviceComponent } from '../../admin/transactions/admin-master-transactions/shared-components/view-payment-advice/view-payment-advice.component';
