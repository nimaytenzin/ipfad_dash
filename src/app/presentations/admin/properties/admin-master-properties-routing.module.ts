...
import { AdminViewBuildingComponent } from './buildings/buildings/admin-view-building/admin-view-building.component';
import { AdminListBuildingsComponent } from './buildings/buildings/admin-list-buildings/admin-list-buildings.component';
import { AdminViewUnitComponent } from './buildings/building-units/admin-view-unit/admin-view-unit.component';
import { AdminListUnitsComponent } from './buildings/building-units/admin-list-units/admin-list-units.component';
...
import { AdminPropertySearchComponent } from './shared/admin-property-search/admin-property-search.component';
