...
@Component({
    selector: 'app-admin-building-security-deposit-paid-payment-advice',
    templateUrl:
        './admin-building-security-deposit-paid-payment-advice.component.html',
    styleUrls: [
        './admin-building-security-deposit-paid-payment-advice.component.css',
    ],
    standalone: true,
    imports: [TableModule, ButtonModule, PaginatorModule, CommonModule],
    providers: [DialogService],
})
export class AdminBuildingSecurityDepositPaidPaymentAdviceComponent
    implements OnInit
{
