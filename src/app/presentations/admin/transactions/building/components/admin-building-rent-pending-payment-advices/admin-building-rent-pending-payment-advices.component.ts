...
@Component({
    selector: 'app-admin-building-rent-pending-payment-advices',
    templateUrl: './admin-building-rent-pending-payment-advices.component.html',
    styleUrls: ['./admin-building-rent-pending-payment-advices.component.css'],
    standalone: true,
    imports: [TableModule, ButtonModule, PaginatorModule, CommonModule],
    providers: [DialogService],
})
export class AdminBuildingRentPendingPaymentAdvicesComponent implements OnInit {
