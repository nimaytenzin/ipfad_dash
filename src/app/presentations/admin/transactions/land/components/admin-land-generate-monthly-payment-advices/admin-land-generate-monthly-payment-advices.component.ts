...
import { CurrentRoleDTO } from 'src/app/core/dataservice/users-and-auth/dto/auth.dto';
...
@Component({
    selector: 'app-admin-land-generate-monthly-payment-advices',
    templateUrl: './admin-land-generate-monthly-payment-advices.component.html',
    styleUrls: ['./admin-land-generate-monthly-payment-advices.component.css'],
    standalone: true,
    imports: [
        CommonModule,
        ButtonModule,
...
export class AdminLandGenerateMonthlyPaymentAdvicesComponent implements OnInit {
