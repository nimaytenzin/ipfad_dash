...
import { LEASESTATUS, INVOICESTATUS } from 'src/app/core/constants/enums';
...
@Component({
    selector: 'app-admin-building-lease-pending-listings',
    templateUrl: './admin-building-lease-pending-listings.component.html',
    styleUrls: ['./admin-building-lease-pending-listings.component.css'],
    standalone: true,
    imports: [
        CheckboxModule,
        FormsModule,
...
export class AdminBuildingLeasePendingListingsComponent implements OnInit {
    ...
    downloadMasterTable() {
        ...
        this.excelGeneratorService
            .DownloadAllPendingBuildingLeaseByAdmin(
                this.authService.GetCurrentRole().adminId
            )
            .subscribe((blob: Blob) => {
                ...
                a.href = url;
                a.download = 'Pending Building Lease.xlsx';
