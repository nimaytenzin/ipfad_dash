...
@Component({
    selector: 'app-admin-building-lease-active-listings',
    templateUrl: './admin-building-lease-active-listings.component.html',
    styleUrls: ['./admin-building-lease-active-listings.component.css'],
    standalone: true,
    imports: [
        CheckboxModule,
        FormsModule,
...
export class AdminBuildingLeaseActiveListingsComponent implements OnInit {
    ...
    downloadMasterTable() {
        ...
        this.excelGeneratorService
            .DownloadAllActiveBuildingLeaseByAdmin(
                this.authService.GetCurrentRole().adminId
            )
            .subscribe((blob: Blob) => {
                ...
                a.href = url;
                a.download = 'Active Building Lease.xlsx';
