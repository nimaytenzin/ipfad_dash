...
@Component({
    selector: 'app-admin-land-lease-active-listings',
    templateUrl: './admin-land-lease-active-listings.component.html',
    styleUrls: ['./admin-land-lease-active-listings.component.css'],
    standalone: true,
    imports: [
        CheckboxModule,
        FormsModule,
...
export class AdminLandLeaseActiveListingsComponent implements OnInit {
    ...
    downloadMasterTable() {
        ...
        this.excelGeneratorService
            ...
            .subscribe((blob: Blob) => {
                ...
                a.href = url;
                a.download = 'Active Land Lease.xlsx';
