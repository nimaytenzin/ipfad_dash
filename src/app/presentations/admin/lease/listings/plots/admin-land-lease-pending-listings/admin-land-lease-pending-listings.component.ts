...
@Component({
    selector: 'app-admin-land-lease-pending-listings',
    templateUrl: './admin-land-lease-pending-listings.component.html',
    styleUrls: ['./admin-land-lease-pending-listings.component.css'],
    standalone: true,
    imports: [
        CheckboxModule,
        FormsModule,
...
export class AdminLandLeasePendingListingsComponent implements OnInit {
    ...
    downloadMasterTable() {
        ...
        this.excelGeneratorService
            ...
            .subscribe((blob: Blob) => {
                ...
                a.href = url;
                a.download = 'Pending Land Lease.xlsx';
