...
@Component({
    selector: 'app-admin-unit-lease-upcoming-expiration-listings',
    templateUrl:
        './admin-unit-lease-upcoming-expiration-listings.component.html',
    styleUrls: [
        './admin-unit-lease-upcoming-expiration-listings.component.css',
    ],
    standalone: true,
    imports: [
        CheckboxModule,
...
export class AdminUnitLeaseUpcomingExpirationListingsComponent
    implements OnInit
{
    ...
    downloadMasterTable() {
        ...
        this.excelGeneratorService
            ...
            .subscribe((blob: Blob) => {
                ...
                a.href = url;
                a.download = 'Expiring unit Lease.xlsx';
